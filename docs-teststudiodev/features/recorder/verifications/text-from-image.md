...
There are few things that could ensure more stable and reliable test execution:
  ...
  ![Green](/features/recorder/verifications/images/text-from-image/fig1.png) Use Text from Image Verification when you need to verify the text in an exact and static image.

  ![Green](/features/recorder/verifications/images/text-from-image/fig1.png) Specify only the part of the image which has the text, because logos and other symbols might be misinterpreted as characters.

  ![Red](/features/recorder/verifications/images/text-from-image/fig2.png) Do not use Text from Image Verification to verify a dynamic slide show or GIFs.
...
![Configure Test Step](images/text-from-image/fig9.png)
