...
![TreeView](images/using-chained-find-expressions/fig1.png)
...
![FindExpression](images/using-chained-find-expressions/fig2.png)
...
1. First, select the target element in the **Elements Explorer** and select Edit in Live from the context menu.
    ...
    ![Edit in Live](images/using-chained-find-expressions/fig3.png)
    ...
    ![Find settings](images/using-chained-find-expressions/fig4.png)
...
![Change find settings](images/using-chained-find-expressions/fig5.png)

Selecting a suggestion from the left will add it to the existing filter(s) for the selected element in the chained find.

![Add new filter](images/using-chained-find-expressions/fig6.png)

Once you have added  a new filter, you can remove the old sequential one.

![Delete filter](images/using-chained-find-expressions/fig7.png)
...
![New expression](images/using-chained-find-expressions/fig8.png)

You can confirm that your chained find works by using the **Validate** button.

![Validate](images/using-chained-find-expressions/fig9.png)
...
![Locate in DOM](images/using-chained-find-expressions/fig10.png)
...
![Locate in DOM](images/using-chained-find-expressions/fig11.png)
