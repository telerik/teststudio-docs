...
![Certificate](images/register-certificate/fig1.png)
...
2. Click **Register certificate for https connection** under *Connection settings*.
    ...
    ![Register certificate](images/register-certificate/fig2.png)
...
![Security Warning](images/register-certificate/fig3.png)
