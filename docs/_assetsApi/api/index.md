...
blockquote {
  ...
  background-image: url("/teststudio/assets/important-icon.svg");
  color: #fff;
  ...
  blockquote.caution {
    ...
    background-image: url("/teststudio/assets/caution-icon.svg"); }
  blockquote.tip {
    background-color: #e4f1df;
    background-image: url("/teststudio/assets/tip-icon.svg"); }
