...
<colgroup>
	...
	<tbody>
	<tr>
		<td style="text-align:center; height:10px;"><img src="/img/getting-started/analyze-the-results/fig01.png" alt="passed step icon" /></td>
		<td style="text-align:center; height:10px;"><img src="/img/getting-started/analyze-the-results/fig02.png" alt="step failure icon" /></td>
	</tr>
	<tr>
