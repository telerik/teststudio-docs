...
![Project Explorer](/img/features/project-explorer/overview/project-explorer-navigate.png)
...
![Collapse Button](/img/features/project-explorer/overview/colapse-button.png)
...
![Project Context Menu](/img/features/project-explorer/overview/projects-right-click-menu.png)
...
![Test File Context Menu](/img/features/project-explorer/overview/test-right-click-menu.png)
...
![Folder Context Menu](/img/features/project-explorer/overview/folder-right-click-menu.png)
