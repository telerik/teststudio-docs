...
![Excel Import](/img/features/testing-types/manual-testing/import-export/inport-tab-button.png)

Next, specify the file, table and column for your manual test steps.

![Binding](/img/features/testing-types/manual-testing/import-export/import-excel-propmt.png)

To export your manual test steps to an Excel workbook, click the ‘Export to Excel’ button.

![Excel Export](/img/features/testing-types/manual-testing/import-export/export-tab-button.png)
