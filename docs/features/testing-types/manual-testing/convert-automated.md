...
![IsManual](/img/features/testing-types/manual-testing/convert-automated/navigate-to-props.png)
...
![Unchecked](/img/features/testing-types/manual-testing/convert-automated/ismanual-unchecked.png)
