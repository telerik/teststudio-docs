...
2. Click the Add-Ins Page link.
	...
	![Add-Ins Page](/img/features/integration/quality-center/conectivity-instructions/fig1.png)

3. Click the **HP Quality Center Connectivity** link.

	![Quality Center](/img/features/integration/quality-center/conectivity-instructions/fig2.png)

4. Click **Download Add-In**.

	![Download Add-in](/img/features/integration/quality-center/conectivity-instructions/fig3.png)
