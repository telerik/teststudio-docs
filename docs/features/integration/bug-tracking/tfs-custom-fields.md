...
![Error](/img/features/integration/bug-tracking/tfs-custom-fields/fig1.png)
...
![New Bug](/img/features/integration/bug-tracking/tfs-custom-fields/fig2.png)
...
![Bug Trackers](/img/features/integration/bug-tracking/tfs-custom-fields/fig3.png)
...
![Bug Submitted](/img/features/integration/bug-tracking/tfs-custom-fields/fig4.png)

6. Open the bug in TFS and note the required field was filled in based on the XML file:

![Bug TFS](/img/features/integration/bug-tracking/tfs-custom-fields/fig5.png)
