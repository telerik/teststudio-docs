...
![Create Table](/img/features/data-driven-testing/oracle-db-example/fig1.png)
...
![Create Table](/img/features/data-driven-testing/oracle-db-example/fig4.png)

2. In the **Create new data source** dialog - for **Data Source Types** choose **Database**

![Create New Data Source](/img/features/data-driven-testing/oracle-db-example/fig2.png)
...
![Bind To Table](/img/features/data-driven-testing/oracle-db-example/fig3.png)
