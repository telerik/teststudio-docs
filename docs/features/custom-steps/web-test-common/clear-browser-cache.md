...
![Add Clear Cache Step](/img/features/custom-steps/clear-browser-cache/step-builder-clear-cache.png)

This step clears **all** cookies, temp files or history from the active browser. You can choose which of these to delete.

![Clear Cache Step](/img/features/custom-steps/clear-browser-cache/extended-menu-clear-cache.png)
