...
![Add Inspection Point Step](/img/features/custom-steps/inspection-point/step-builder-inspc-point.png)
...
![Inspect Browser DOM Step](/img/features/custom-steps/inspection-point/inspect-dom.png)
