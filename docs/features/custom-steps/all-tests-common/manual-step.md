...
![Manual Step from Step Builder](/img/features/custom-steps/manual-step/step-builder-manual-steps.png)
...
![Manual Step in test](/img/features/custom-steps/manual-step/manual-step-props.png)
