...
![Execution Delay Step](/img/features/custom-steps/execution-delay/step-builder-execution-delay.png)

Change the amount of time to wait in the step's property _WaitTime_:

![Execution Delay properties](/img/features/custom-steps/execution-delay/change-time-box.png)
