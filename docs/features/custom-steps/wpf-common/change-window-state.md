...
![Add Change Window State Step](/img/features/custom-steps/change-window-state/step-builder-change-window.png)
...
![Step Properties](/img/features/custom-steps/change-window-state/extended-menu-change-window.png)
