...
![storyboard tab](/img/features/test-maintenance/storyboard/storyboard-tab-location.png)
...
![List of steps](/img/features/test-maintenance/storyboard/storyboard-panel.png)
...
![Image preview](/img/features/test-maintenance/storyboard/scale-window.png)
...
![Switch to steps](/img/features/test-maintenance/storyboard/switch-to-steps-in-test.png)
...
![Switch to horizontal layout](/img/features/test-maintenance/storyboard/change-storyboard-orientaiton.png)
...
![Predefined images for custom steps](/img/features/test-maintenance/storyboard/specific-img-storyboard.png)
...
![Recapture](/img/features/test-maintenance/storyboard/recapture-storyboard.png)

Once a browser is selected, there is a prompt message to confirm the __Recapture__ attempt.

![warning](/img/features/test-maintenance/storyboard/fig10.png)
...
![Export](/img/features/test-maintenance/storyboard/storyboard-to-html.png)
...
![Exported HTML](/img/features/test-maintenance/storyboard/fig9.png)
