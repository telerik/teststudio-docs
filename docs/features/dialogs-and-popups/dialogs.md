...
![Step Builder Dialogs section](/img/features/dialogs-and-popups/dialogs/dialog-step-builder.png)
...
![Dialog steps timeouts](/img/features/dialogs-and-popups/dialogs/timeouts-extended-menu.png)
...
![Choosing wrong handle button](/img/features/dialogs-and-popups/dialogs/button-warning.png)
...
![File Locations](/img/features/dialogs-and-popups/dialogs/download-path.png)
...
![Multiple files upload](/img/features/dialogs-and-popups/dialogs/file-upload-extended-menu.png)
...
![FilePath property in WPF SaveFile](/img/features/dialogs-and-popups/dialogs/filepath-in-savefile-dialog.png)
...
![FilePath property in WPF OpenFile](/img/features/dialogs-and-popups/dialogs/open-file-dialog-multiple-file.png)
