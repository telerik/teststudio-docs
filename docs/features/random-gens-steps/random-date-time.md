...
![Add Generate Random Date and Time step](/img/features/random-data/random-date/step-cuilder-dnt.png)
...
![Generate Random Date and Time step properties](/img/features/random-data/random-date/extended-menu-rnd-dnt.png)
