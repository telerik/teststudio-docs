...
![Add Generate Current Date and Time step](/img/features/random-data/current-date/step-builder-current-dnt.png)
...
![Generate Current Date and Time step properties](/img/features/random-data/current-date/extended-menu-current-dnt.png)
