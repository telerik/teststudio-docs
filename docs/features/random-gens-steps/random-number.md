...
![Add Generate Random Number step](/img/features/random-data/random-number/step-builder-rnd-num.png)
...
![Generate Random Number step properties](/img/features/random-data/random-number/extended-menu-rnd-num.png)
