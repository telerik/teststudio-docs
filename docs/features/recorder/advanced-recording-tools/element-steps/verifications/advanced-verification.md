...
![Verifications section in Elements Steps](/img/features/recorder/advanced-recording-tools/element-steps/verifications/advanced-verification/fig2.png)
...
![Verifications suggestions](/img/features/recorder/advanced-recording-tools/element-steps/verifications/advanced-verification/fig3.png)

Building the verification sentence allows you to choose different comparison operators. 

![Comparison operators](/img/features/recorder/advanced-recording-tools/element-steps/verifications/advanced-verification/fig4.png)

3. Once finished building the verification, click the **Add Step** button to insert it in the test. 

![Add Step](/img/features/recorder/advanced-recording-tools/element-steps/verifications/advanced-verification/fig5.png)
...
![Step Properties](/img/features/recorder/advanced-recording-tools/element-steps/verifications/advanced-verification/fig6.png)
...
![Step Builder Verification](/img/features/recorder/advanced-recording-tools/element-steps/verifications/advanced-verification/fig7.png)
