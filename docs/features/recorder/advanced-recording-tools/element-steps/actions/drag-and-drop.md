...
![Select Drag & Drop Step](/img/features/recorder/advanced-recording-tools/element-steps/actions/drag-and-drop/fig1.png)
...
![Pick Target Element](/img/features/recorder/advanced-recording-tools/element-steps/actions/drag-and-drop/fig2.png)
...
![Element Center Add](/img/features/recorder/advanced-recording-tools/element-steps/actions/drag-and-drop/fig3.png)
 
5. Click the **Add Step** button and the __Drag&Drop__ step is added to the test specifying the two elements you worked with.

![Drag&Drop Step](/img/features/recorder/advanced-recording-tools/element-steps/actions/drag-and-drop/fig4.png)
...
![Drag&Drop Step properties](/img/features/recorder/advanced-recording-tools/element-steps/actions/drag-and-drop/fig5.png)
...
![Drag element offset properties](/img/features/recorder/advanced-recording-tools/element-steps/actions/drag-and-drop/fig6.png)
...
![Drop element properties](/img/features/recorder/advanced-recording-tools/element-steps/actions/drag-and-drop/fig7.png)
...
![Drop element offset properties](/img/features/recorder/advanced-recording-tools/element-steps/actions/drag-and-drop/fig8.png)
...
![Drop target type properties](/img/features/recorder/advanced-recording-tools/element-steps/actions/drag-and-drop/fig9.png)
...
![Drop target type window properties](/img/features/recorder/advanced-recording-tools/element-steps/actions/drag-and-drop/fig10.png)
