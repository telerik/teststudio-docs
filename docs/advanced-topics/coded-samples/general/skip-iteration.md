...
![Create two tests](/img/advanced-topics/coded-samples/general/skip-iteration/fig1.png)
...
![Inherint Parent Datasource](/img/advanced-topics/coded-samples/general/skip-iteration/fig2.png)
