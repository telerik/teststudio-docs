...
![Locate in DOM](/img/troubleshooting-guide/test-execution-problems-tg/invoke-blind-mouse-click/fig1.png)
...
![Specific Point](/img/troubleshooting-guide/test-execution-problems-tg/invoke-blind-mouse-click/fig2.png)
...
![Crosshair](/img/troubleshooting-guide/test-execution-problems-tg/invoke-blind-mouse-click/fig3.png)

3. Click **Add Step**.

![Add Step](/img/troubleshooting-guide/test-execution-problems-tg/invoke-blind-mouse-click/fig4.png)

4. Once done a new step with the prefix "Desktop command" should appear in your test.

![Test Steps](/img/troubleshooting-guide/test-execution-problems-tg/invoke-blind-mouse-click/fig5.png)
