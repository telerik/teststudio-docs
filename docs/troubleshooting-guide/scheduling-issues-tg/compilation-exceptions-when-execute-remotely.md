...
![Defined Element](/img/troubleshooting-guide/scheduling-issues-tg/compilation-exceptions-when-execute-remotely/fig1.png)

Though the same element could be reached from another test for example - in a *RunTest* coded step (on the image below).

![Used in Different Test](/img/troubleshooting-guide/scheduling-issues-tg/compilation-exceptions-when-execute-remotely/fig2.png)
...
![Different Logic](/img/troubleshooting-guide/scheduling-issues-tg/compilation-exceptions-when-execute-remotely/fig3.png)
