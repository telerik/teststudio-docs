...
![Create connection](/img/knowledge-base/scheduling-kb/drop-storage-database/fig1.png)
...
![Drop the entire database](/img/knowledge-base/scheduling-kb/drop-storage-database/fig2.png)
...
![Drop single collections](/img/knowledge-base/scheduling-kb/drop-storage-database/fig3.png)
