...
![using statements](/img/knowledge-base/test-execution-kb/execute-selenium-test/fig1.png)

5. Paste/write the selenium test in the coded step:

![code sample](/img/knowledge-base/test-execution-kb/execute-selenium-test/fig2.png)
