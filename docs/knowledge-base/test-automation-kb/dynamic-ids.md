...
1. Open the Project Settings menu:
    ...
    <img src="/img/knowledge-base/test-automation-kb/dynamic-ids/fig1.png" alt="Standalone" /><br>**Standalone version**</td>
	<td>
	
	<img src="/img/knowledge-base/test-automation-kb/dynamic-ids/fig2.png" alt="VS Plugin" /><br>**VS Plugin**</td>
	<tr>
	</table>

2. Go to **Find Logic** from the navigation bar on the left:

	![Identificaiton logic](/img/knowledge-base/test-automation-kb/dynamic-ids/fig3.png)
...
![Element explorer](/img/knowledge-base/test-automation-kb/dynamic-ids/fig4.png)
