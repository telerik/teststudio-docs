...
![Random string](/img/knowledge-base/dialogs-and-popups-kb/variable-query-strings/fig1.png)
...
![Duplicate elements](/img/knowledge-base/dialogs-and-popups-kb/variable-query-strings/fig2.png)
...
1. Modify the **CompareMode** property for all page nodes involved (click on a page node in Elements Explorer, then open the Properties window). Change it from **FullPathAndQuery** to **FullPath**.
	...
	![Change compare mode](/img/knowledge-base/dialogs-and-popups-kb/variable-query-strings/fig3.png)
...
2. After modifying each page node involved the Element Explorer will refresh itself. Now your duplicate pages will be merged into one. Any duplicate elements will be removed leaving behind only the unique elements displayed under the now truly unique page nodes. Here's a screenshot after performing this process on my test recording:
	...
	![Mergeing nodes](/img/knowledge-base/dialogs-and-popups-kb/variable-query-strings/fig4.png)
...
1. Open Project Settings.
	...
	<img src="/img/knowledge-base/dialogs-and-popups-kb/variable-query-strings/fig5.png" alt="Standalone" /><br>**Standalone version**</td>
	<td>
	
	<img src="/img/knowledge-base/dialogs-and-popups-kb/variable-query-strings/fig6.png" alt="VS Plugin" /><br>**VS Plugin**</td>
	<tr>
	</table>
...
3. Change the **Compare Mode** from **FullPathAndQuery** to **FullPath**.
	...
	![Recording Options](/img/knowledge-base/dialogs-and-popups-kb/variable-query-strings/fig7.png)
...
![Pop up URL](/img/knowledge-base/dialogs-and-popups-kb/variable-query-strings/fig8.png)
...
![Partial Match](/img/knowledge-base/dialogs-and-popups-kb/variable-query-strings/fig9.png)
