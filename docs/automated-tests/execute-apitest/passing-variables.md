...
![Use variable from API test in a web test](/img/features/execute-apitest/passing-variables/use-variable-in-web-test.png)
...
![Variables property](/img/features/execute-apitest/passing-variables/variables-property.png)
...
![Varianle pane](/img/features/execute-apitest/passing-variables/variable-pane.png)
...
![Add Varianle](/img/features/execute-apitest/passing-variables/add-variable.png)
