...
![Open Test list result](/img/automated-tests/test-list-results/calendar/fig6.png)
...
![Test results](/img/automated-tests/test-list-results/analyze-test-results/fig1.png)
...
![Test results](/img/automated-tests/test-list-results/analyze-test-results/fig1a.png)
...
![Step results](/img/automated-tests/test-list-results/analyze-test-results/fig2.png)
...
![Step results](/img/automated-tests/test-list-results/analyze-test-results/fig2a.png)
...
![Performance test list results](/img/automated-tests/test-list-results/analyze-test-results/fig31.png)
...
![Test as step results](/img/automated-tests/test-list-results/analyze-test-results/fig4.png)
...
![Successful Test List Result with Warnings](/img/automated-tests/test-list-results/analyze-test-results/fig10.png)
...
![Test List result Warning details](/img/automated-tests/test-list-results/analyze-test-results/fig11.png)
...
![Resolve Find Expression warning](/img/automated-tests/test-list-results/analyze-test-results/fig12.gif)
...
![Image based search failure in step failure details](/img/automated-tests/test-list-results/analyze-test-results/fig13.png)
...
![In development tests results](/img/automated-tests/test-list-results/analyze-test-results/fig5.png)
...
![Automatic Re-run of Failed Tests Results](/img/automated-tests/test-list-results/analyze-test-results/fig6.png)
...
![Screen Recording Info icon](/img/automated-tests/test-list-results/analyze-test-results/fig7.png)
...
![Play the recorded video](/img/automated-tests/test-list-results/analyze-test-results/fig8.png)
