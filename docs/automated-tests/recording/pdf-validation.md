...
![Steps recorded automatically for test automation pdf](/img/automated-tests/recording/validate-pdf/fig1.png)
...
![Add Open pdf step in test from step builder](/img/automated-tests/recording/validate-pdf/fig2.png)
...
![Open pdf from step context menu in test from step builder](/img/automated-tests/recording/validate-pdf/fig2a.png)
...
![Open pdf from step context menu in test from step builder](/img/automated-tests/recording/validate-pdf/fig2b.png)
...
![pdf control toolbar](/img/automated-tests/recording/validate-pdf/fig3.png)
...
![steps recorded against the pdf control toolbar](/img/automated-tests/recording/validate-pdf/fig4.png)
