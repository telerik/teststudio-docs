...
**Open** Git project in the terms of Test Studio is equal to __cloning an existing repository__. This option will create a local copy of the remote project in the specified folder during establishing connection.
