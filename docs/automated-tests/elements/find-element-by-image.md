...
![Image Settings](/img/features/elements-explorer/find-element-by-image/fig0.png)
...
![Image Settings](/img/features/elements-explorer/find-element-by-image/fig0a.png)
...
![Image Preview](/img/features/elements-explorer/find-element-by-image/fig1.png)
...
![Edit Elements Pane](/img/features/elements-explorer/find-element-by-image/fig2.png)
...
![Image used by](/img/features/elements-explorer/find-element-by-image/fig3.png)
...
![Apply Image for certain steps, delete image](/img/features/elements-explorer/find-element-by-image/fig3a.png)

### Image Preview

The recorded image is displayed in the *Image Preview* section.

![Image preview ](/img/features/elements-explorer/find-element-by-image/fig4.png)

Click on the image to see it in full size. In this preview you can zoom in or out of the image.

![Image preview Full size](/img/features/elements-explorer/find-element-by-image/fig5.png)
...
![Image Recognition Settings](/img/features/elements-explorer/find-element-by-image/fig6.png)
...
![Image Settings Update the Image](/img/features/elements-explorer/find-element-by-image/fig7.png)
...
![Upload New File](/img/features/elements-explorer/find-element-by-image/fig8.png)

### Select From Browser

The option to select an image from browser will prompt to select a recording browser to perform the image recording. 

![Select From Browser](/img/features/elements-explorer/find-element-by-image/fig9.png)
...
![Image Recorder Attached](/img/features/elements-explorer/find-element-by-image/fig10.png)
...
![Select a Step to Run to](/img/features/elements-explorer/find-element-by-image/fig11.png)

Next you need to select a recording browser.

![Select a Browser to Run to](/img/features/elements-explorer/find-element-by-image/fig12.png)
...
![Enable Image Recording](/img/features/elements-explorer/find-element-by-image/fig13.png)
...
![Capture New Image](/img/features/elements-explorer/find-element-by-image/fig14.gif)
...
![Resize the Selected Image](/img/features/elements-explorer/find-element-by-image/fig15.gif)
...
![Image in Use vs. Current Selection](/img/features/elements-explorer/find-element-by-image/fig16.png)
...
![Index and Threshold](/img/features/elements-explorer/find-element-by-image/fig17.png)
...
![Index and Threshold Gif](/img/features/elements-explorer/find-element-by-image/fig17a.gif)

### Save or Discard Changes

Once the image selection is complete, you have few options to save or discard the current changes.

![Save, Discard, Cancel](/img/features/elements-explorer/find-element-by-image/fig18.png)
