...
![Element's Pane](/img/features/elements-explorer/find-element/fig103.png)
...
![Save/Reset](/img/features/elements-explorer/find-element/fig105.png)
...
![Select steps](/img/features/elements-explorer/find-element/fig106.png)
...
![Add/Delete Filter](/img/features/elements-explorer/find-element/fig107.png)

From the **Edit Element** pane you can start a recording session choosing between:

![Start recording session](/img/features/elements-explorer/find-element/fig108.png)
...
![Select step to execute to](/img/features/elements-explorer/find-element/fig109.png)
...
![Choose Active Recorder](/img/features/elements-explorer/find-element/fig110.png)
...
![Element Find expression, suggestions and DOM tree](/img/features/elements-explorer/find-element/fig111.png)
...
![DOM explorer](/img/features/elements-explorer/find-element/fig112.png)
...
![Update Filter](/img/features/elements-explorer/find-element/fig113.png)

Hover over the info icon next to the button to see what is the backup search for that element.

![Backup Search](/img/features/elements-explorer/find-element/fig114.png)
...
![Element Not found](/img/features/elements-explorer/find-element/fig115.png)

Use the **Validate Expression** button to validate the changed find expression filters.

![Validate Expression](/img/features/elements-explorer/find-element/fig116.png)
...
![Switch to Elements Image Settings](/img/features/elements-explorer/find-element/fig130.png)

## Advanced Mode

**Advanced Mode** button displays the current find expression in text format and allows you to type in a custom one.

![Advanced Mode](/img/features/elements-explorer/find-element/fig117.png)
...
![Select column to attach to filter](/img/features/elements-explorer/find-element/fig118.png)
...
![Warning message](/img/features/elements-explorer/find-element/fig119.png)
...
![Bind Coded variable](/img/features/elements-explorer/find-element/fig120.png)
