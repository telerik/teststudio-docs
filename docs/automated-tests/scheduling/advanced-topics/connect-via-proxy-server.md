...
![Reverse proxy connect-communication key](/img/features/scheduling-test-runs/connect-via-proxy/fig2a.png)
...
![Reverse proxy connect- certificate](/img/features/scheduling-test-runs/connect-via-proxy/fig2b.png)
...
![Run via proxy](/img/features/scheduling-test-runs/connect-via-proxy/fig2.png)
...
![Connection successful message](/img/features/scheduling-test-runs/connect-via-proxy/fig3a.png)

## Confirm Connection 

Once the connection is successfully established, click the **Confirm** button to apply the changes in the project. 

![Confirm Reverse proxy connection](/img/features/scheduling-test-runs/connect-via-proxy/fig3.png)
