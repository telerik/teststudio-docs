...
1. Click the **Configure** button in the **Set Up** ribbon.
    ...
    ![Click configure button](/img/features/testing-types/performance-testing/gather-perfomance-data/fig15.png)
...
4. Click the **Add a computer** button.
    ...
    ![Add a computer](/img/features/testing-types/performance-testing/gather-perfomance-data/fig4.png)
...
6. Click the **Connect** button to confirm a connection can be established. 
    ...
    ![Connect](/img/features/testing-types/performance-testing/gather-perfomance-data/fig5.png)
    ...
    > <br> 
    > ![View Log](/img/features/testing-types/performance-testing/gather-perfomance-data/fig6.png)
...
7. In the section labeled **Select the system resources that you want to monitor** choose from the list with __Available Counters__. Select an entire group, or expand the group to select specific counters within it.
    ...
    ![Available Counters](/img/features/testing-types/performance-testing/gather-perfomance-data/fig8.png)
...
8. You can save this set of performance counters as a template, click ![Disk](/img/features/testing-types/performance-testing/gather-perfomance-data/fig12.png).

    ![Save New Template](/img/features/testing-types/performance-testing/gather-perfomance-data/fig13.png)

9. Click **Done Editing** when finished. Click **Cancel** to revert changes. Click **Delete** to remove this server configuration.

10. To import a previously saved template of performance counters, click ![Folder](/img/features/testing-types/performance-testing/gather-perfomance-data/fig9.png) .

    ![Saved template](/img/features/testing-types/performance-testing/gather-perfomance-data/fig10.png)
...
![Add Template](/img/features/testing-types/performance-testing/gather-perfomance-data/fig11.png)
