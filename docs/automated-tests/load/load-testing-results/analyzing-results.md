...
![Results showed during the test run](/img/features/testing-types/load-testing/analyzing-results/fig1a.png)
...
![Current test run Results](/img/features/testing-types/load-testing/analyzing-results/fig1.png)
...
![Passed or Failed test indication for running tests with predefined goals](/img/features/testing-types/load-testing/analyzing-results/fig2.png)
...
![Overall Results](/img/features/testing-types/load-testing/analyzing-results/fig3.png)
...
![Dashboard Results](/img/features/testing-types/load-testing/analyzing-results/fig4.png)

### Goals Results

The **Goal** tab is empty for load test runs without set goals.

![Empty Goals Results](/img/features/testing-types/load-testing/analyzing-results/fig5.png)

When the load test is using goals to determine its outcome, the **Goals** tab shows details for the particular goal.

![Goals Results](/img/features/testing-types/load-testing/analyzing-results/fig6.png)
...
![Page Specific Metrics Results](/img/features/testing-types/load-testing/analyzing-results/fig7.png)

A click on any of the listed URLs, opens additional details for the HTTP response code and status message.

![Page Specific Metrics http response details](/img/features/testing-types/load-testing/analyzing-results/fig8.png)
...
![Detailed Metrics Results](/img/features/testing-types/load-testing/analyzing-results/fig9.png)
...
![Statistical calculations and graph view](/img/features/testing-types/load-testing/analyzing-results/fig10.png)

Moving the mouse through the graphical representation of the collected metrics, changes the values in the ***'Current'*** column.

![Current column](/img/features/testing-types/load-testing/analyzing-results/fig11.png)
...
![Constant values calculated based on the collected metrics](/img/features/testing-types/load-testing/analyzing-results/fig12.png)
...
![Compare different load agents](/img/features/testing-types/load-testing/analyzing-results/fig13.png)
...
![Different load agents source](/img/features/testing-types/load-testing/analyzing-results/fig14.png)
...
![Select metrics from different runs](/img/features/testing-types/load-testing/analyzing-results/fig15.png)
...
![Different load test runs](/img/features/testing-types/load-testing/analyzing-results/fig16.png)
