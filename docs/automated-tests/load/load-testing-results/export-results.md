...
![Export button](/img/features/testing-types/load-testing/export-results/fig1.png)
...
![html export](/img/features/testing-types/load-testing/export-results/fig2.png)
...
![Overall Test Statistics](/img/features/testing-types/load-testing/export-results/fig3.png)

The **Error details** tab presents details for the Http errors, if any.

![Error Details](/img/features/testing-types/load-testing/export-results/fig4.png)
...
![Raw data](/img/features/testing-types/load-testing/export-results/fig5.png)
