...
![Add computer](/img/features/testing-types/load-testing/monitor-perf-metrics/fig1.png)
...
![Computer name](/img/features/testing-types/load-testing/monitor-perf-metrics/fig2.png)

2. Once the connection to the target machine is verified, the list with all **Available Counters** is populated.

![Available Counters](/img/features/testing-types/load-testing/monitor-perf-metrics/fig3.png)

3. Select each object you wish to monitor. Then, you may select specific counters for each object in the sub-list.

![Specific counters](/img/features/testing-types/load-testing/monitor-perf-metrics/fig4.png)

5. To save this set of performance counters for use with other load tests or machines:

  a. Click ![disk](/img/features/testing-types/load-testing/monitor-perf-metrics/fig5.png)

  b. Input a name for the performance template. 

![Template](/img/features/testing-types/load-testing/monitor-perf-metrics/fig6.png)

6. Click **Save**.

![Save](/img/features/testing-types/load-testing/monitor-perf-metrics/fig7.png)
...
![Entry](/img/features/testing-types/load-testing/monitor-perf-metrics/fig8.png)
