...
3. Run it to extract it somewhere (permanent). Then cd to it, run **ruby dk.rb**  **init and ruby dk.rb install**, **devkitvars.bat** to bind it to ruby installations in your path.
