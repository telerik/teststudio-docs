...
![License agreement](/img/features/scheduling-test-runs/install-runtime/fig1.png)
...
![Default installation](/img/features/scheduling-test-runs/install-runtime/fig2.png)
...
![Customize installation](/img/features/scheduling-test-runs/install-runtime/fig3.png)
...
![Remove Single component](/img/features/scheduling-test-runs/install-runtime/fig4.png)

![Remove multiple components](/img/features/scheduling-test-runs/install-runtime/fig5.png)

In the *Customize* section you **can also change the default installation folder** if necessary.

![Modify Installation path](/img/features/scheduling-test-runs/install-runtime/fig6.png)
...
![Perform installation](/img/features/scheduling-test-runs/install-runtime/fig7.png)
...
![Finish installation](/img/features/scheduling-test-runs/install-runtime/fig8.png)
